...
class AppLifecycleObserver with GlobalPageVisibilityObserver {
  ...
  void onForeground(Route route) {
    ...
    Logger.log("AppLifecycleObserver ${route.settings.name} - onForeground");
  }
...
class LifecycleTestPage extends StatefulWidget {
  ...
  @override
  LifecycleTestPageState createState() => LifecycleTestPageState();
}

class LifecycleTestPageState extends State<LifecycleTestPage>
        ...
        child: Column(
          ...
          children: [
            ...
            CupertinoButton.filled(
                ...
                onPressed: () {
                  Logger.log("push simple page");
                  BoostNavigator.instance
                      .push("simplePage", withContainer: true)
                      .then((value) => Logger.log("push simple page after"));
                }),
          ],
        ),
      ),
